...
You can connect to the newly imported database through [Studio](studio/Studio-Home-page.md) or the [Console](Console-Commands.md) using the OrientDB's default database users, e.g. using the user _admin_ and password _admin_.
