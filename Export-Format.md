...
This page contains the format used by [Export Database](Console-Command-Export.md) and [Import Database](Console-Command-Import.md) tools. The file is 100% JSON compliant.
