...
OrientDB provides an API called [OGraphBatchInsertBasic](http://orientdb.com/javadoc/latest/com/orientechnologies/orient/graph/batch/OGraphBatchInsertBasic.html).
