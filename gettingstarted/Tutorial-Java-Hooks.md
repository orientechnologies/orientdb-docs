...
It is also assumed that you have [downloaded](http://orientdb.dev/download/), installed, and configured a working OrientDB Server. In my case I installed it to folder C:\Program Files\orientdb-community-2.0.5.
