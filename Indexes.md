...
Creates a new index. To create an automatic index bound to a schema property use section "ON" of create index command or use as name the <code>&lt;class.property&gt;</code> notation. But assure to have created the schema for it before the index. See the example below.
...
For more information look at [Drop index command](SQL-Drop-Index.md).
...
[Here](Custom-Index-Engine.md) a guide how to create a custom index engine.
