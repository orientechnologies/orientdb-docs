...
In developing your application, bear in mind that OrientDB needs to know the class inheritance relationship.  This is an abstract concept that applies to both  [POJO's](Object-Database.md#inheritance) and  [Documents](Document-API-Class.md).
