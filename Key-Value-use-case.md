...
## Create an entry ##
To create a new entry in the database use the [Index-PUT API](OrientDB-REST.md#put---index).
...
## Retrieve an entry ##
To retrieve an entry from the database use the [Index-GET API](OrientDB-REST.md#put---index).
...
```
## Remove an entry ##
To remove an entry from the database use the [Index-DELETE API](OrientDB-REST.md#put---index).
