...
To enable and configure the clustering between nodes, add and enable the **OHazelcastPlugin** plugin. It is configured as a [Server Plugin](../internals/DB-Server.md#handlers). The default configuration is reported below.
