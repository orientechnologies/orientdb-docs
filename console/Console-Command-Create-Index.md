...
>The SQL [`CREATE INDEX`](../sql/SQL-Create-Index.md) page provides more information on creating indexes.  More information on indexing can be found under [Indexes](../Indexes.md). Further SQL information can be found under [`SQL Commands`](../sql/SQL.md).
>
