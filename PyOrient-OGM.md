...
The purpose of the OGM is to make interactions with large and complex Graph databases moreunderstable and easier to maintain.  It bridges the gap between higher level object-oriented concepts in your application and the vertices and edges in your database.
