...
Since TinkePop stack has been removed as a dependency from the OrientDB Community Edition, starting with version 3.0 it will be available for [download](http://orientdb.dev/download) as an Apache TinkerPop 3 enabled edition of OrientDB based on the Community Edition.
...
Dowload the latest version of OrientDB-TP3 [here](https://orientdb.dev/download-2/).
