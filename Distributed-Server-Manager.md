...
This is part of [Distributed Architecture](Distributed-Architecture.md). Configure a distributed clustered architecture. This task is configured as a [Server handler](DB-Server.md#plugins). The task can be configured easily by changing these parameters:
...
Default configuration in [orientdb-server-config.xml](Distributed-Configuration.md#orientdb-server-configxml):
