...
Official [orientdb](http://orientdb.dev/orientdb/) driver for node.js. Fast, lightweight, uses the binary protocol.
...
- [API Docs](http://orientdb.dev/docs/last/orientjs/OrientJS.html)
