...
This will dump the profiler in the console every 60 seconds and resets the metrics after the dump. For more information about settings look at [Parameters](Performance-Tuning.md).
