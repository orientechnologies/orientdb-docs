...
* During the import, OrientDB's [`WAL`](http://orientdb.dev/docs/3.2.x/Configuration.html#storageusewal) and [`WAL_SYNC_ON_PAGE_FLUSH`](http://orientdb.dev/docs/3.2.x/Configuration.html#storagewalsynconpageflush
...
You can connect to the newly imported database through [Studio](../studio/README.md) or the [Console](../console/README.md) using the OrientDB's default database users, e.g. using the user _admin_ and password _admin_.
