...
OrientDB provides an API called [OGraphBatchInsertBasic]({{ book.javadoc }}/com/orientechnologies/orient/graph/batch/OGraphBatchInsertBasic.html).
...
OrientDB provides an API called [OGraphBatchInsert]({{ book.javadoc }}/com/orientechnologies/orient/graph/batch/OGraphBatchInsert.html).
