...
|---|---|
| `orient.getDatabase()` | Returns the current [document database](http://www.orientdb.dev/javadoc/latest/com/orientechnologies/orient/core/db/document/ODatabaseDocumentTx.html) instance. |
