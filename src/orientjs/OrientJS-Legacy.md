...
> The support for the new version of the OrientDB protocol is currently in beta, with new APIs in order to support new OrientDB features. See [here](OrientJS.md) the OrientJS 3.0 documentation.
