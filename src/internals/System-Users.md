...
## Users and Roles
To create new *System users*, they are added to the system database, and the procedure is identical to adding a user as outlined in [Database Security](http://orientdb.dev/docs/3.2.x/Database-Security.html).
