...
For older release or more information go to the official [download page](http://orientdb.dev/download/).
...
- [OrientDB Enterprise Edition](http://www.orientdb.dev/orientdb-enterprise), based on the Community Edition, adds Enterprise Level features. It's available with [support](http://www.orientdb.dev/support) by Orient Technologies company and has a commercial version.
...
Download **latest official release** at  [this page](http://orientdb.dev/download/).
...
Below the badges you can use in your web site, application and presentation to say to the world "Hey, I'm using OrientDB!". The best would be linking that button to the web site: <http://www.orientdb.dev>
