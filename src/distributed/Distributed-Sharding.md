...
![image](http://www.orientdb.dev/images/distributed-sharding-class.png)
...
![image](http://www.orientdb.dev/images/distributed-sharding-replica-class.png)
...
![image](http://www.orientdb.dev/images/distributed-query-map.png)

In this case the query is executed across all the 3 nodes and then filtered again on the starting node.

![image](http://www.orientdb.dev/images/distributed-query-reduce.png)
...
With Community Edition the distributed configuration cannot be changed at run-time but you have to stop and restart all the nodes. [Enterprise Edition](http://www.orientdb.dev/orientdb-enterprise) allows to create and drop new shards without stopping the distributed cluster.
