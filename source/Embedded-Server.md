...
- Java application that runs embedded with the server can bypass the remote connection and use the database directly with [local mode](https://github.com/nuvolabase/orientdb/wiki/Concepts#wiki-Database_URL). local and remote connections against the same database can work in concurrency: OrientDB will synchronize the access.
- You can use the [Console](https://github.com/nuvolabase/orientdb/wiki/Console-Commands) to control it
- You can use the [OrientDB Studio](https://github.com/nuvolabase/orientdb/wiki/OrientDB-Studio)
